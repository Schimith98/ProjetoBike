package br.edu.iff.projetobike.controller.apirest;
...
@RestController
@RequestMapping(path="/apirest/bicicletas")
public class BicicletaController {
    ...
    @PostMapping
    public ResponseEntity save(@Valid @RequestBody Bicicleta bicicleta){
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity update(@PathVariable("id") Long id, @Valid @RequestBody Bicicleta bicicleta){
